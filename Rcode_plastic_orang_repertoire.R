...
# step 3a: create a table for the set of behaviors (Behavior2) used by every individual (animal_ID) AT LEAST TWICE ---
...
# step 6a: select within and between group dyads from the Dice data frame ---
